...
public class TextPatternItems_SSI extends TextPatternItemsExtend implements TextPatternPool, TextPatternReceivingItems, TextPatternAcceptedAttributeList {

    private final int AMOUNT_OF_POOL= 3;

    private TextPatternItemsExtend[] pool = {new TextPatternItemsExtend<String>() , new TextPatternItemsExtend<String>() ,new TextPatternItemsExtend<Integer>() };

    public TextPatternItems_SSI() {
